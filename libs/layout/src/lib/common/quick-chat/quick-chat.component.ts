...
import { QuickChatService } from '@twentythree/layout/common/quick-chat/quick-chat.service';
import { Chat } from '@twentythree/layout/common/quick-chat/quick-chat.types';
