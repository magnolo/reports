...
import { fuseAnimations } from '@twentythree/fuse/animations';
import {
  FuseNavigationItem,
  FuseVerticalNavigationAppearance,
  FuseVerticalNavigationMode,
  FuseVerticalNavigationPosition,
} from '@twentythree/fuse/components/navigation/navigation.types';
import { FuseNavigationService } from '@twentythree/fuse/components/navigation/navigation.service';
import { FuseScrollbarDirective } from '@twentythree/fuse/directives/scrollbar/scrollbar.directive';
import { FuseUtilsService } from '@twentythree/fuse/services/utils/utils.service';
  ...
  implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
  ...
  @Output() readonly hoverChanged: EventEmitter<boolean> =
    new EventEmitter<boolean>();
  @Output()
  ...
  private _onMouseenter(): void {
    ...
    // Set the hovered
    this.hovered = true;
    this.hoverChanged.next(this.hovered);
  }
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if ('lockMenu' in changes) {
      if (changes.lockMenu.currentValue && !this.hovered) {
        this.hovered = true;
      }
    }
  }
